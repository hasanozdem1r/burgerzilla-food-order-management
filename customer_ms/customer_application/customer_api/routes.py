...
"""
# path : root/customer_ms/customer_application/customer_api/routes.py
...
from .customer_utils import (
    ...
    check_add_customer_params,
    get_add_customer_params,
    initialize_customer,
)
        ...
        try:
            ...
            if is_params_valid:
                ...
                (
                    ...
                    c_postal_code,
                    c_phone_number,
                ) = get_add_customer_params(request_data=form_data)
                # initialize order
