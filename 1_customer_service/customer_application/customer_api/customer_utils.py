...
def check_add_customer_params(request_data:dict)->bool:
    ...
    params=['c-email','c-full-name','c-address','c-city','c-postal-code','c-phone-number']
...
def initialize_customer(customer,c_email,c_full_name,c_address,c_city,c_postal_code,c_phone_number):
